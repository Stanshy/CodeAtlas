...
- [ ] 架構文件完整描述三視角方法級改造策略
- [ ] 架構文件完整描述智慧聚合升級邏輯
- [ ] feature-spec v13.0 包含所有 Sprint 13 功能描述
- [ ] data-model v6.0 包含 ApiEndpoint/EndpointGraph/ChainStep/DirectoryNode 擴充
- [ ] api-design v6.0 包含 /api/graph 回應的 endpointGraph 欄位
